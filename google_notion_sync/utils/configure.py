...
GOOGLE_DRIVE_GOOGLE_CALENDAR_FILE_ID = os.getenv(
    'GOOGLE_DRIVE_GOOGLE_CALENDAR_FILE_ID')
...
ALL_GOOGLE_CALENDARS_DICT = {}
for calendar in ALL_GOOGLE_CALENDARS:
    calendar_values = list(calendar.values())
    ALL_GOOGLE_CALENDARS_DICT[calendar_values[0]] = calendar_values[1]
